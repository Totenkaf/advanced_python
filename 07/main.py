...
if __name__ == "__main__":
    ...
    if args.type in ["C++", "c++", "CPP", "cpp", "c"]:
        ...
        matrixes.matrixes_ctypes.multiply_matrix_chain_command(matrix_chain_pattern, args.edge)
    else:
        with open(
            args.input_fd, "r", encoding="utf-8"
        ) if args.input_fd != "stdin" else sys.stdin as input_fd:
            matrixes.matrixes_python.multiply_matrix_chain_command(args.chain, args.is_random, input_fd)
