[![build-and-test](https://github.com/Totenkaf/async-python-sprint-5/actions/workflows/app-testing.yml/badge.svg)](https://github.com/Totenkaf/async-python-sprint-5/actions/workflows/app-testing.yml)
...
#### 1. Создайте .env по аналогии с .env.example
#### 2. Поднимите микросервисное окружение и проверьте их состояние
~~~bash
...
- cache - контейнер с Redis In Memory DB как кэш
...
# запустить тесты совместно с генерацией покрытия проекта
