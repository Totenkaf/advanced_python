[![build-and-test](https://github.com/Totenkaf/async-python-sprint-1/actions/workflows/app-testing.yml/badge.svg)](https://github.com/Totenkaf/async-python-sprint-1/actions/workflows/app-testing.yml)
...
3. Опишите этапы решения в виде отдельных классов в модуле [tasks.py](common/tasks.py):
